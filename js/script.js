...
function calculateMarks() {
    ...
    outputBox.innerHTML = `
      ...
      <br><br>
      <strong>PW1:</strong> ${pw1} / 100
      <br>
      <strong>PW2:</strong> ${pw2} / 100
      <hr>
      <strong>Total:</strong> ${total} / 200
      <br>
      <strong>Average:</strong> ${average.toFixed(2)} / 100
      <br>
      <strong>Percentage:</strong> ${percentage.toFixed(2)}%
      <br><br>
      <strong>Grade:</strong> <label>${grade}</label>
    `;
}
